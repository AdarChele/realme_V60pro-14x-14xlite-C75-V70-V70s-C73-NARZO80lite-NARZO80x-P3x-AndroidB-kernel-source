...
#if defined(OV50D40_MIPI_RAW_ALPHAB5)
    {
        SENSOR_DRVNAME_OV50D40_MIPI_RAW_ALPHAB5,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(OV50D40_ST_MIPI_RAW_ALPHAB5)
    {
        SENSOR_DRVNAME_OV50D40_ST_MIPI_RAW_ALPHAB5,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(GC08A8_MIPI_RAW_ALPHAB5)
    {
        SENSOR_DRVNAME_GC08A8_MIPI_RAW_ALPHAB5,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  3},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC08A8ST_MIPI_RAW_ALPHAB5)
    {
        SENSOR_DRVNAME_GC08A8ST_MIPI_RAW_ALPHAB5,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  3},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(SC202CS_MIPI_RAW_ALPHAB5)
    {
        SENSOR_DRVNAME_SC202CS_MIPI_RAW_ALPHAB5,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(GC02M1B_MIPI_MONO_ALPHAB5)
    {
        SENSOR_DRVNAME_GC02M1B_MIPI_MONO_ALPHAB5,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(GC32E2_MIPI_RAW_ALPHAB5)
    {
        SENSOR_DRVNAME_GC32E2_MIPI_RAW_ALPHAB5,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  1},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(SC520CS_MIPI_RAW_ALPHAB5)
    {
        SENSOR_DRVNAME_SC520CS_MIPI_RAW_ALPHAB5,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  3},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(MOV50D40_MIPI_RAW_CHOPARDM)
    {
        SENSOR_DRVNAME_MOV50D40_MIPI_RAW_CHOPARDM,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(GC50F6_MIPI_RAW_CHOPARD)
    {
        SENSOR_DRVNAME_GC50F6_MIPI_RAW_CHOPARD,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(FOV50D40_MIPI_RAW_CHOPARDF)
    {
        SENSOR_DRVNAME_FOV50D40_MIPI_RAW_CHOPARDF,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(SC202CS_MIPI_RAW_CHOPARD)
    {
        SENSOR_DRVNAME_SC202CS_MIPI_RAW_CHOPARD,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 0},//5
            {AVDD, Vol_2800, 1},//3
...
#endif
#if defined(OV02F_MIPI_RAW_CHOPARD)
	{
		SENSOR_DRVNAME_OV02F_MIPI_RAW_CHOPARD,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 5},
...
#endif
#if defined(GC50F6_MIPI_RAW_MUMBAI)
    {
        SENSOR_DRVNAME_GC50F6_MIPI_RAW_MUMBAI,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(IMX852_MIPI_RAW_MUMBAI)
    {
...
#endif
#if defined(SC800CS_MIPI_RAW_MUMBAI)
    {
        SENSOR_DRVNAME_SC800CS_MIPI_RAW_MUMBAI,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 5},
            {DVDD, Vol_1200, 4},
...
#endif
#if defined(GC08A8_MIPI_RAW_MUMBAI)
    {
        SENSOR_DRVNAME_GC08A8_MIPI_RAW_MUMBAI,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  1},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(OV50D40_MIPI_RAW_MUMBAI)
    {
        SENSOR_DRVNAME_OV50D40_MIPI_RAW_MUMBAI,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(OV50D40_MIPI_RAW_24707)
    {
        SENSOR_DRVNAME_OV50D40_MIPI_RAW_24707,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
