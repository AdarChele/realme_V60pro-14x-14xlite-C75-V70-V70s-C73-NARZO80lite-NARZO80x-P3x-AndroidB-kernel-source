...
//chognqing
UINT32 CHONGQING_SHINETECH_FRONT_OV08D10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02B1B_MIPI_MONO_CHONGQING_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KHM6S_MIPI_RAW_CHONGQING_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5K3P9SP_MIPI_RAW_CHONGQING_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KJN1_MIPI_RAW_CHONGQING_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV64B_MIPI_RAW_CHONGQING_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 HI1336_MIPI_RAW_CHONGQING_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

UINT32 S5KHM6S_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KJN1_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV50C40_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV13B10_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV08D10_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC820CS_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC1300CS_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC202CS_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KJN1_MIPI_RAW_23706_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV50C40_MIPI_RAW_23706_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV08D10_MIPI_RAW_23706_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC16B3C_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KJNS_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC202CS_MIPI_RAW_24690_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1_MIPI_RAW_24690_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//rado
UINT32 HI846_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV50D40_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV13B10_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC820CS_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC202CS_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M3_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KJNS_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IMX471_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC32E2_MIPI_RAW_RADO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV50D40_MIPI_RAW_24707_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//DONGFENG
UINT32 OV50D40_MIPI_RAW_DONGFENG_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1_MIPI_RAW_DONGFENG_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC201ACS_MIPI_RAW_DONGFENG_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IMX471_MIPI_RAW_DONGFENG_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//CHOPARD
UINT32 MOV50D40_MIPI_RAW_CHOPARDM_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC50F6_MIPI_RAW_CHOPARD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 FOV50D40_MIPI_RAW_CHOPARDF_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC202CS_MIPI_RAW_CHOPARD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02F_MIPI_RAW_CHOPARD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//MUMBAI
UINT32 GC50F6_MIPI_RAW_MUMBAI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IMX852_MIPI_RAW_MUMBAI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC800CS_MIPI_RAW_MUMBAI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC08A8_MIPI_RAW_MUMBAI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV50D40_MIPI_RAW_MUMBAI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//AL5
UINT32 OV50D40_MIPI_RAW_AVATARL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC32E2_MIPI_RAW_AVATARL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 GC08A8_MIPI_RAW_AVATARL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1B_MIPI_MONO_AVATARL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
// AMG
UINT32 OV50D40_MIPI_RAW_23281_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IMX615_MIPI_RAW_23281_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IMX355_MIPI_RAW_23281_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02B10_MIPI_RAW_23281_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02B1B_MIPI_MONO_23281_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

UINT32 GC08A8_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC32E1_MIPI_RAW_BARLEY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC32E1_MIPI_RAW_24688_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC08A8_MIPI_RAW_23706_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
// AB5
UINT32 OV50D40_MIPI_RAW_AVATARB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV08D10_MIPI_RAW_AVATARB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC520CS_MIPI_RAW_AVATARB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

//Alpha L5
UINT32 OV50D40_MIPI_RAW_ALPHAL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC08A8_MIPI_RAW_ALPHAL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC202CS_MIPI_RAW_ALPHAL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1B_MIPI_MONO_ALPHAL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 GC08A8_MIPI_RAW_BAIKALL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC202CS_MIPI_RAW_BAIKALL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1B_MIPI_MONO_BAIKALL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

//BaikalB5
UINT32 OV50D40_MIPI_RAW_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV50D40_ST_MIPI_RAW_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV13B10_MIPI_RAW_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IMX480_MIPI_RAW_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC08A8_MIPI_RAW_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC520CS_MIPI_RAW_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC202CS_MIPI_RAW_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1B_MIPI_MONO_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02F_MIPI_MONO_BAIKALB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

//Alpha B5
UINT32 OV50D40_MIPI_RAW_ALPHAB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV50D40_ST_MIPI_RAW_ALPHAB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC08A8_MIPI_RAW_ALPHAB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC08A8ST_MIPI_RAW_ALPHAB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC202CS_MIPI_RAW_ALPHAB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1B_MIPI_MONO_ALPHAB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC520CS_MIPI_RAW_ALPHAB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC32E2_MIPI_RAW_ALPHAB5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
