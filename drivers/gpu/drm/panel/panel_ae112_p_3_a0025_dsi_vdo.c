...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	//FOD position
	lcm_dcs_write_seq_static(ctx,0x88,0x01,0x02,0x1C,0x08,0x79,0x00,0x00,0x00,0x00);
	//H resolution
	...
	//Vesa dsi 1.1 8bit
	lcm_dcs_write_seq_static(ctx,0x91,0x89,0x28,0x00,0x04,0xC2,0x00,0x02,0x0E,0x00,0x56,0x00,0x07,0x20,0x00,0x19,0x6D,0x10,0xF0);
	//BC Control on
	lcm_dcs_write_seq_static(ctx,0x53,0x20);
	//video porch setup
	lcm_dcs_write_seq_static(ctx,0x3B,0x00,0x1C,0x00,0x30,0x00,0x1C,0x03,0x60,0x00,0x1C,0x09,0xC0,0x00,0x1C,0x00,0x30);
	...
	lcm_dcs_write_seq_static(ctx,0xB5,0x24,0xC6);
	lcm_dcs_write_seq_static(ctx,0x6F,0x23);
	lcm_dcs_write_seq_static(ctx,0xB5,0x24,0x06);
	//DMR setup
	lcm_dcs_write_seq_static(ctx,0xF0,0x55,0xAA,0x52,0x08,0x04);
	lcm_dcs_write_seq_static(ctx,0x6F,0x02);
	lcm_dcs_write_seq_static(ctx,0xB5,0x0C);
	...
	lcm_dcs_write_seq_static(ctx,0x6F,0x69);
	lcm_dcs_write_seq_static(ctx,0xB8,0x17,0xA0,0x17,0xA0);
	//CHECK FFD
        lcm_dcs_write_seq_static(ctx,0xF0,0x55,0xAA,0x52,0x08,0x08);
        lcm_dcs_write_seq_static(ctx,0xE0,0x33,0x01,0x01,0x01);
        lcm_dcs_write_seq_static(ctx,0x6F,0x06);
        lcm_dcs_write_seq_static(ctx,0xE0,0x80,0x01,0x21,0x32,0x43,0x54,0x65,0x76,0x87,0x98,0x99,0x99,0x99);
        lcm_dcs_write_seq_static(ctx,0xED,0x10,0x10,0x00);
        lcm_dcs_write_seq_static(ctx,0xF0,0x55,0xAA,0x52,0x08,0x08);
        lcm_dcs_write_seq_static(ctx,0xE1,0x11,0x08,0x05,0x05,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0xE2,0x19,0x15,0x15,0x15,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0xE3,0x00,0x00,0x00,0x00,0x0C,0x0C,0x11,0x11);
        lcm_dcs_write_seq_static(ctx,0xE4,0x05,0x08,0x0A,0x01,0x02,0x03);
        lcm_dcs_write_seq_static(ctx,0xE5,0x05,0x0B,0x10,0x05,0x0A,0x10);
        lcm_dcs_write_seq_static(ctx,0xE6,0x00,0x00,0x00,0x00,0x00,0x00);
        lcm_dcs_write_seq_static(ctx,0x6F,0x08);
        lcm_dcs_write_seq_static(ctx,0xE1,0x11,0x11,0x07,0x07,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x08);
        lcm_dcs_write_seq_static(ctx,0xE2,0x15,0x15,0x13,0x13,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x08);
        lcm_dcs_write_seq_static(ctx,0xE3,0x00,0x00,0x00,0x00,0x0C,0x0C,0x11,0x11);
        lcm_dcs_write_seq_static(ctx,0x6F,0x10);
        lcm_dcs_write_seq_static(ctx,0xE1,0x14,0x15,0x07,0x07,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x10);
        lcm_dcs_write_seq_static(ctx,0xE2,0x14,0x15,0x0D,0x0B,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x10);
        lcm_dcs_write_seq_static(ctx,0xE3,0x00,0x00,0x00,0x00,0x0C,0x0C,0x11,0x11);
        lcm_dcs_write_seq_static(ctx,0x6F,0x18);
        lcm_dcs_write_seq_static(ctx,0xE1,0x14,0x15,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x18);
        lcm_dcs_write_seq_static(ctx,0xE2,0x14,0x15,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x18);
        lcm_dcs_write_seq_static(ctx,0xE3,0x00,0x00,0x00,0x06,0x0C,0x0C,0x11,0x11);
        lcm_dcs_write_seq_static(ctx,0x6F,0x20);
        lcm_dcs_write_seq_static(ctx,0xE1,0x10,0x10,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x20);
        lcm_dcs_write_seq_static(ctx,0xE2,0x10,0x10,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x20);
        lcm_dcs_write_seq_static(ctx,0xE3,0x00,0x00,0x00,0x06,0x0C,0x0C,0x11,0x11);
        lcm_dcs_write_seq_static(ctx,0x6F,0x28);
        lcm_dcs_write_seq_static(ctx,0xE1,0x0F,0x06,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x28);
        lcm_dcs_write_seq_static(ctx,0xE2,0x0F,0x06,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x28);
        lcm_dcs_write_seq_static(ctx,0xE3,0x03,0x00,0x00,0x06,0x0C,0x0C,0x11,0x11);
        ...
        lcm_dcs_write_seq_static(ctx,0xE1,0x08,0x06,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x38);
        lcm_dcs_write_seq_static(ctx,0xE2,0x08,0x06,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x38);
        lcm_dcs_write_seq_static(ctx,0xE3,0x03,0x00,0x00,0x06,0x0C,0x0C,0x11,0x11);
        lcm_dcs_write_seq_static(ctx,0x6F,0x40);
        lcm_dcs_write_seq_static(ctx,0xE1,0x04,0x06,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x40);
        lcm_dcs_write_seq_static(ctx,0xE2,0x04,0x06,0x0D,0x09,0x0C,0x0C,0x12,0x12);
        lcm_dcs_write_seq_static(ctx,0x6F,0x40);
        lcm_dcs_write_seq_static(ctx,0xE3,0x03,0x00,0x00,0x06,0x0C,0x0C,0x11,0x11);
	//sleep out
