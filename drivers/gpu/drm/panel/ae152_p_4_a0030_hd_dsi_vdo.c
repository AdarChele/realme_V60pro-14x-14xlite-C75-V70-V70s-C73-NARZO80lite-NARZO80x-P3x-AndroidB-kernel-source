 ...
 ** OPLUS_EDIT
 ** File: ae152_p_4_a0030_hd_dsi_vdo.c
...
#endif
#include "ae152_p_4_a0030_hd_dsi_vdo.h"
				 ...
				 unsigned int level)
{
	...
	pr_info("%s, p_4_a0030 exit backlight level = %d, bl_map = %d, oplus_display_brightness = %d, backlight_last_level=%d\n",
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
        ...
        pr_info("%s+ jdi_probe enter p_4_a0030, vdo,120hz\n", __func__);
	...
	register_device_proc("lcd", "A0030", "P_4");
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "ae152,p_4,a0030,hd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "ae152_p_4_a0030_hd_dsi_vdo",
                .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("P_4 A0030 VDO 120HZ LCD Panel Driver");
