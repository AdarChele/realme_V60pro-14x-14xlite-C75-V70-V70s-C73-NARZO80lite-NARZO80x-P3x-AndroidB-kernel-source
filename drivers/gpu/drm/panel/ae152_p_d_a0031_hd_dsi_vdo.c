...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xC1, 0x30, 0x81, 0x50, 0xfa, 0x01, 0x00, 0x00,
	0x10, 0x00, 0x00, 0x00, 0x00, 0x40, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0,
	0x06, 0xD6, 0x07, 0x08, 0x0A, 0xB0);
	jdi_dcs_write_seq_static(ctx, 0xCE, 0x16, 0x10, 0x42, 0x4b, 0x4e, 0x5c, 0x60,
	0x62, 0x7f, 0x8b, 0x9f, 0xaf, 0xb6, 0xba, 0xbf, 0xc4, 0xc9, 0x0f, 0x06, 0x04,
	0x04, 0x00, 0x04, 0x8c);
...
static void cabc_mode_retore(struct jdi *ctx)
{
	...
	if (cabc_mode_backup == 1) {
		...
		jdi_dcs_write_seq_static(ctx, 0x55, 0x23);
